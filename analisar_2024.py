...
file_path = r'C:\Users\Diego\Documents\GitHub\Trabalho-Topicos-em-Dados\downloads\dengue24_mes.csv'
...
# Carregar a tabela de análise resultante
analise_result = pd.DataFrame({
    'Confirmados': [54688, 162931, 306519],
    'Notificados': [0, 393925, 616591]
